...
if(!isset($_SESSION['user_id']) && !empty($_COOKIE['rememberme'])){
    ...
    $sql = "SELECT * FROM rememberme where authentificator = '$authentificator1'";
    ...
    if(!hash_equals($row['f2authentificator'], $f2authentificator2)){
        ...
        //Log the user in and redirect to loggedinpage
