...
try {
    ...
    //Recipients
    $mail->setFrom('smd32046@gmail.com', 'Md sanaullah');
    $mail->addAddress($email, $firstname);     //Add a recipient
    //$mail->addAddress('ellen@example.com');               //Name is optional
    $mail->addReplyTo('smd32046@gmail.com', 'Information');
    ...
    $mail->send();
    echo "<div class='alert alert-success'>Thank for your registring! A confirmation mail has been sent to $email. Please click on the activation link to activate your account.</div>";
} catch (Exception $e) {
